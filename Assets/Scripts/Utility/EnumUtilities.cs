...
public abstract class EnumUtilities<TClass>
	where TClass : class
{
	private static readonly System.Random _random = new System.Random((int)DateTime.Now.Ticks);
	
	/// <summary>
	/// Gets a random enum value of type TEnum.
	/// </summary>
	/// <returns>The random.</returns>
	/// <typeparam name="TEnum">The enum type we want a random value from.</typeparam>
...
/// <summary>
/// Enforces Enum type for EnumUtilities.
/// </summary>
public class Enums : EnumUtilities<Enum>
{
